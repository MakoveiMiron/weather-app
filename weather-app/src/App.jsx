      ...
      {loading ? (
        ...
        <div className="weather-dashboard">
          ...
          <div className="grid-container">
            ...
            <div className="grid-item">
              <h2>Visibility</h2>
              <div className="value">{(data.currentConditions.visibility * 1.60934).toFixed(1)} km</div>
            </div>
            <div className="grid-item">
              <h2>Wind Speed</h2>
              <div className="value">{(data.currentConditions.windspeed * 1.60934).toFixed(1)} km/h</div>
            </div>
            <div className="grid-item">
